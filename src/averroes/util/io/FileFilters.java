...
public class FileFilters {
	public static IOFileFilter classFileFilter = FileFilterUtils
			.suffixFileFilter("class");
	
	public static IOFileFilter jarFileFilter = FileFilterUtils
			.suffixFileFilter("jar");
	
	public static IOFileFilter jreFileFilter = FileFilterUtils.or(
