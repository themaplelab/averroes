...
public final class DefaultPropertiesValues {
	...
	public static final String DEFAULT_AVERROES_PROPERTIES_FILENAME = "averroes.properties";
	
	public static final String DEFAULT_APPLICATION_INCLUDES = "**";

	public static final String DEFAULT_MAIN_CLASS = "Main";

	public static final String DEFAULT_INPUT_JAR_FILES = "app.jar";
