...
/**
 * LinkedList from the java.util.collections framework. Simplified by
 * eliminating superclasses, removing uses of generics. Copied modCount
 * field and a few iterator methods from abstract superclasses to make
 * this code self-contained.
 *
 */
public class LL implements Iterable {
    ...
    public boolean addAll(int index, Collection c) {
        ...
        for (Object o : a) {
            @SuppressWarnings("unchecked") Object e = (Object) o;
