...
/**
 * LinkedList class copied from java.util.collections. Eliminated the use of
 * generics, and uses of the transient keyword". Copied declarations of
 * modCount, iterator() and listIterator() from abstract superclasses to make
