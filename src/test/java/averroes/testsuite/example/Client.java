...
/**
 * This example is intended to illustrate how approximating the behavior of the
 * above library classes with different levels of precision affects a client
 * analysis. In the example below, it is assumed that the client is a static
 * taint analysis that tracks simple data flows. Here, the function "secret()"
 * is assumed to be the source of tainted values, and the print statements
