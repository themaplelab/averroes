...
public class A {
	...
	public Iterator keys() {
		...
		set_m2 = new Iterator(){ // inferred from allocation
			@Override
			...
			// weirdly, static fields are not allowed in non-static nested classes (and hence anonymous classes)
	...
	public Iterator values() {
		...
		set_m3 = new Iterator(){ // inferred from allocation
